...
Check other strategies for an idea of the required contract. There are existing
specs to check all strategies confirm to the contract, so ensure the full suit
(using "rake") is green.

== Ideas

* classify each check as warning/error
